...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class VPCDPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Preference bluetoothSettings = findPreference("bluetoothSettings");
            bluetoothSettings.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
                public boolean onPreferenceClick(Preference preference) {
    ...
    private void handleScannedURI(Uri uri) {
        try {
            ...
            if ("bluetooth".equalsIgnoreCase(uri.getHost())
                    || "bluetooth".equalsIgnoreCase(uri.getQueryParameter("transport"))) {
                final String address = uri.getQueryParameter("address");
                if (address == null || address.isEmpty()) {
                    throw new IllegalArgumentException("Bluetooth address missing");
                }
                SP.edit().putString("transport_mode", TransportMode.BLUETOOTH_CLIENT.preferenceValue()).apply();
                SP.edit().putString("bluetooth_address", address).apply();
                getFragmentManager().beginTransaction().replace(android.R.id.content,
                        new VPCDPreferenceFragment()).commit();
                return;
            }
            ...
            SP.edit().putString("transport_mode", TransportMode.TCP.preferenceValue()).apply();
